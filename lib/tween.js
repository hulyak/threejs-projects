...
!(function () {
  ...
  var t = n,
    ...
    M = null;
  for (var T in n)
    r[T] = parseFloat (n[T], 10);
  (this.to = function (n, t) {
    return void 0 !== t && (u = t), (i = n), this;
  }), (this.start = function (n) {
    TWEEN.add (this), (f = !0), (v = !1), (h = void 0 !== n
      ? n
      : TWEEN.now ()), (h += s);
    for (var u in i) {
      ...
      void 0 !== r[u] &&
        ((r[u] = t[u]), r[u] instanceof Array == !1 && (r[u] *= 1), (o[u] =
          r[u] || 0));
    }
    return this;
  }), (this.stop = function () {
    return f
      ? (TWEEN.remove (this), (f = !1), null !== M &&
          M.call (t), this.stopChainedTweens (), this)
      : this;
  }), (this.stopChainedTweens = function () {
    for (var n = 0, t = p.length; t > n; n++)
      p[n].stop ();
    ...
    var f, M, T;
    if (h > n) return !0;
    v === !1 && (null !== d && d.call (t), (v = !0)), (M =
      (n - h) / u), (M = M > 1 ? 1 : M), (T = l (M));
    for (f in i)
      if (void 0 !== r[f]) {
        var N = r[f] || 0, W = i[f];
        W instanceof Array
          ? (t[f] = E (W, T))
          : ('string' == typeof W &&
              (W = '+' === W.charAt (0) || '-' === W.charAt (0)
                ? N + parseFloat (W, 10)
                : parseFloat (W, 10)), 'number' == typeof W &&
              (t[f] = N + (W - N) * T));
      }
  ...
  Utils: {
    ...
    CatmullRom: function (n, t, r, i, o) {
      var u = 0.5 * (r - n), e = 0.5 * (i - t), a = o * o, f = o * a;
      return (
        (2 * t - 2 * r + u + e) * f +
        (-3 * t + 3 * r - 2 * u - e) * a +
        u * o +
